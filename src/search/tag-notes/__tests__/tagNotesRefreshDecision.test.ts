...
vi.mock("cards/list/ui/TagNotesListHost.svelte", () => ({
	default: {},
}));
vi.mock("obsidian-integration/views/abstractSvelteListView", () => ({
	AbstractSvelteListView: class {},
}));

import { shouldRefreshTagNotesForContext } from "search/tag-notes/TagNotesView";
