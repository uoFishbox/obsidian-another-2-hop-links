...
import type { FrameScheduler } from "obsidian-integration/lifecycle/frameScheduler";
import type { DOMMutationObserver } from "obsidian-integration/observers/DOMMutationObserver";
