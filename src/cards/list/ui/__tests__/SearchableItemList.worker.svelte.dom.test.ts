...
vi.mock("cards/grid/ui/FlatCardGrid.svelte", async () => {
...
function createManyTaggedNoteItems(basenamePrefix: string, count: number): CardItem[] {
...
function createTestProps(overrides?: { items?: CardItem[]; sourceFile?: TFile }) {
