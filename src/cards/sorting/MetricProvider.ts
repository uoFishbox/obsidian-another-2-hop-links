...
import { countLinkReferences } from "indexing/metadata/metadataExtractor";
...
} from "cards/title/cardTitle";

export function isBranch(item: SortableItem): item is CardLinkBranch {
	return "hop1" in item && "hop2" in item;
}

export function isBacklink(item: SortableItem): item is IndexedLink {
