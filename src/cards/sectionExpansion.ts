...
interface VisibleLimitSettings {
	readonly defaultVisibleLinkCount: number;
}

/** Expanded item limits keyed by semantic card section id. */
...
export function getDefaultSectionVisibleLimit(settings: VisibleLimitSettings): number {
