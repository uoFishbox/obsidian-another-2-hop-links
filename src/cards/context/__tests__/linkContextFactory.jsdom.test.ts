...
vi.mock("obsidian-integration/workspace/fileOpener", () => ({
	openFile: vi.fn(),
	openLinkDestination: vi.fn(),
}));

vi.mock("obsidian-integration/files/resolveFileByPath", () => ({
...
function createBaseLink(sourceFile: TFile): IndexedLink {
	return {
