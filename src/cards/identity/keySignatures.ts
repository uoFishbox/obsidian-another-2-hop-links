...
import { normalizePathIdentity } from "shared/identity/fileIdentity";
...
export function createBranchUsageSignature(branch: CardLinkBranch): UsageSignature {
...
export function createIndexedLinkUsageSignature(link: IndexedLink): UsageSignature {
