...
import type { PreviewDomCommitScope } from "preview/scheduling/previewDomCommitScheduler";
...
vi.mock("preview/renderers/mathRenderQueue", () => ({
	enqueueMathRender: state.enqueueMathRender,
}));

vi.mock("preview/renderers/markdownPreviewRenderer", () => ({
