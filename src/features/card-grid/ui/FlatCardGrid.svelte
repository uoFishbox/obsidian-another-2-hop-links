<script lang="ts" generics="T">
	import CardGridSurface from "ui/card-grid/surface/CardGridSurface.svelte";
	import CardGridLoadMoreButton from "ui/card-grid/CardGridLoadMoreButton.svelte";
	import {
		useFlatCardGrid,
		type FlatCardGridProps,
	} from "features/card-grid/runtime/flat-grid/useFlatCardGrid.svelte";
	import { provideVirtualPreviewSurface } from "features/card-preview/ui/virtualPreviewSurfaceContext";
	import { provideVirtualFrameCoordinator } from "ui/shared/scheduling/frameCoordinatorContext.svelte";
