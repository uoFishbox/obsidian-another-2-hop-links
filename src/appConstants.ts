...
export const PREVIEW_DOM_COMMIT_RATE_MULTIPLIER = 1.25;
export const DEFAULT_PREVIEW_DOM_COMMITS_PER_SECOND = 80;

/** Keeps preview activation admission within downstream DOM commit capacity. */
export function resolvePreviewActivationsPerSecond(
	domCommitsPerSecond: number,
): number {
