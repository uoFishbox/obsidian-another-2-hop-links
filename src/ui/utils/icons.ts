/**
 * Shared SVG attributes for inline icon rendering.
 *
 ...
 * ```svelte
 * <svg {...svgAttrs} width={size} height={size} class={className}>
...
export const ICON_PATHS = {
	...
	LayoutList:
		'<rect width="7" height="7" x="3" y="3" rx="1"/><rect width="7" height="7" x="3" y="14" rx="1"/><path d="M14 4h7"/><path d="M14 15h7"/>',
