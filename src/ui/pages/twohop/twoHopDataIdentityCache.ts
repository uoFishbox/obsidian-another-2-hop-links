...
} from "./twoHopDataIdentityCache/descriptorIdentity";
import {
	createTwoHopInteractionTokenAllocator,
	type TwoHopInteractionTokenAllocator,
} from "./twoHopDataIdentityCache/interactionTokenAllocator";
import {
	resolveBranchSectionEntry,
	type BranchEntry,
} from "./twoHopDataIdentityCache/createBranchSectionEntries";
import {
	resolveNewLinkSectionEntry,
	type NewLinksEntry,
} from "./twoHopDataIdentityCache/createNewLinkSectionEntries";
import {
	resolvePrimarySectionEntry,
	type PrimaryEntry,
} from "./twoHopDataIdentityCache/createPrimarySectionEntries";
import {
	resolveTagSectionEntry,
	type TagEntry,
} from "./twoHopDataIdentityCache/createTagSectionEntries";
...
function appendPrimarySections(params: {
	...
	readonly resolveParams: ResolveTwoHopDataIdentityParams;
...
export function createTwoHopDataIdentityCache(): TwoHopDataIdentityCache {
	const reconcilers = createReconcilers();
